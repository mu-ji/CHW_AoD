...
if save_flag == 'y':
    ...
    if number_of_node == '1':
        ...
        df.to_csv('outdoor_experiment_data/1d_experiment/node1_data_{}_{}.csv'.format(node1_xangle, node1_yangle))
    elif number_of_node == '2':
        node1_xangle = input('Enter the x position of node1: ')
        node1_yangle = input('Enter the y position of node1: ')
        node2_xangle = input('Enter the x position of node2: ')
        node2_yangle = input('Enter the y position of node2: ')
        node1_df = cut_off_data(node1_data)
        node2_df = cut_off_data(node2_data)
        node1_df.to_csv('outdoor_experiment_data/2d_experiment/node1_data_{}_{}.csv'.format(node1_xangle, node1_yangle))
        node2_df.to_csv('outdoor_experiment_data/2d_experiment/node2_data_{}_{}.csv'.format(node2_xangle, node2_yangle))